...
"S02": dict(loc="plaza", lens=30, fstop=2.8, shake=0.016,
            tgt=(0.00, 0.10, 0.55),
...
"S06": dict(loc="hall", lens=35, fstop=3.0, shake=0.013,
            tgt=(0.00, 0.30, 0.60),
...
"S20": dict(loc="hall", lens=30, fstop=2.8, shake=0.012, door_open=True,
            tgt=(-0.85, 0.95, 0.50),
