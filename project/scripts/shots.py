...
"S02": dict(loc="plaza", lens=30, fstop=3.5, shake=0.016,
            tgt=(0.00, 0.10, 0.55),
            az_a=58, az_b=26, elev_a=5.0, elev_b=6.0, fw_a=5.40, fw_b=5.10,
...
"S04": dict(loc="plaza", lens=45, fstop=2.8, shake=0.011,
            tgt=(-0.55, -1.60, 0.70),
            az_a=150, az_b=162, elev_a=6.0, elev_b=6.0, fw_a=3.40, fw_b=3.40,
            note="Rear 3/4 from behind-left."),
"S05": dict(loc="plaza", lens=60, fstop=2.8, shake=0.008,
            tgt=(-0.80, -1.86, 0.74),
            az_a=128, az_b=150, elev_a=-1.0, elev_b=-0.5, fw_a=1.25, fw_b=1.25,
...
"S06": dict(loc="hall", lens=35, fstop=4.0, shake=0.013,
            tgt=(0.00, 0.30, 0.60),
            az_a=56, az_b=33, elev_a=8.0, elev_b=8.0, fw_a=5.20, fw_b=5.20,
