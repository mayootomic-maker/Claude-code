...
const de = {
  ...
  'occ.many': 'Viele Sitzplätze',
  'occ.some': 'Wenige Sitzplätze',
  'occ.standing': 'Nur Stehplätze',
  'occ.full': 'Voll',
  'occ.unknown': 'Keine Auslastungsdaten',
  'occ.first': '1. Kl.',
  'occ.second': '2. Kl.',
  'disruption.title': 'Störung',
  'attr.exitSide': 'Aussteigeseite',
  'worker.title': 'Eigener Server',
  'worker.hint': 'Optional. Liefert Auslastung und Störungen, die die freie Schnittstelle nicht hat.',
  'worker.url': 'Worker-Adresse',
  'worker.token': 'Gerätetoken',
  'worker.tokenHint': 'Muss dem DEVICE_TOKEN des Workers entsprechen. Bleibt auf diesem Gerät.',
  'worker.test': 'Verbindung testen',
  'worker.testing': 'Wird geprüft',
  'worker.ok': 'Verbunden — Quelle: {source}',
  'worker.authFailed': 'Token abgelehnt',
  'worker.unreachable': 'Server nicht erreichbar',
  'worker.notSet': 'Nicht konfiguriert — es wird direkt die freie Schnittstelle genutzt.',
  'stats.title': 'Deine Kontroll-Statistik',
  'stats.totals': '{inspections} Kontrollen auf {rides} Fahrten',
  'stats.trips': '{trips} verschiedene Verbindungen',
  'stats.since': 'Seit {date}',
  'stats.byWeekday': 'Nach Wochentag',
  'stats.byHour': 'Nach Tageszeit',
  'stats.empty': 'Noch keine Fahrten erfasst.',
  'stats.emptyHint': 'Fahrten werden automatisch erfasst, sobald du unterwegs bist.',
  'stats.close': 'Schliessen',
  'stats.ratio': '{inspections} von {rides}',
  'stats.noRides': 'keine Fahrten',
...
const en: Record<MessageKey, string> = {
  ...
  'occ.many': 'Many seats free',
  'occ.some': 'Few seats free',
  'occ.standing': 'Standing room only',
  'occ.full': 'Full',
  'occ.unknown': 'No occupancy data',
  'occ.first': '1st',
  'occ.second': '2nd',
  'disruption.title': 'Disruption',
  'attr.exitSide': 'Exit side',
  'worker.title': 'Your own server',
  'worker.hint': 'Optional. Adds occupancy and disruptions, which the free API lacks.',
  'worker.url': 'Worker address',
  'worker.token': 'Device token',
  'worker.tokenHint': "Must match the Worker's DEVICE_TOKEN. Stays on this device.",
  'worker.test': 'Test connection',
  'worker.testing': 'Checking',
  'worker.ok': 'Connected — source: {source}',
  'worker.authFailed': 'Token rejected',
  'worker.unreachable': 'Server unreachable',
  'worker.notSet': 'Not configured — using the free API directly.',
  'stats.title': 'Your inspection statistics',
  'stats.totals': '{inspections} inspections across {rides} rides',
  'stats.trips': '{trips} different services',
  'stats.since': 'Since {date}',
  'stats.byWeekday': 'By weekday',
  'stats.byHour': 'By time of day',
  'stats.empty': 'No rides logged yet.',
  'stats.emptyHint': 'Rides are logged automatically once you are under way.',
  'stats.close': 'Close',
  'stats.ratio': '{inspections} of {rides}',
  'stats.noRides': 'no rides',
